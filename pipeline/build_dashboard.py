...
<title>Regulatory Reporting Pipeline · Live Dashboard</title>
...
<header>
  ...
  <h1>Automated Regulatory<br>Reporting <span class="accent">Pipeline</span></h1>
  <p class="subtitle">
    Lending Club 2018 Q4 · <span class="live">{ctx['total_accounts']:,}</span> loan records
    · generated <span class="live">{ctx['generated_at']}</span><span class="blink"></span>
  </p>
</header>
